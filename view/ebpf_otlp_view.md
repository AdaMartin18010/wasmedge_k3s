...
> **提示**：本文档共 1434 行，建议根据需求选择阅读路径。

### 🎯 按角色快速跳转

- **👨‍💻 开发者**：[一、eBPF 技术堆栈全景解析](#一ebpf-技术堆栈全景解析) →
  [二、OTLP 技术堆栈全景解析](#二otlp-技术堆栈全景解析) →
  [三、技术堆栈对比论证](#三技术堆栈对比论证)
- **🏗️ 架构师**：[一、eBPF 技术堆栈全景解析](#一ebpf-技术堆栈全景解析) →
  [四、协同关系深度分析](#四协同关系深度分析) →
  [一、系统自我感知：从观测到认知的跃迁](#一系统自我感知从观测到认知的跃迁)
- **🔧 运维工程师**：[一、eBPF 技术堆栈全景解析](#一ebpf-技术堆栈全景解析) →
  [三、自我治愈：从发现到恢复的闭环](#三自我治愈从发现到恢复的闭环) →
  [二、虚拟化/容器化/沙盒化架构视角：三层隔离模型](#二虚拟化容器化沙盒化架构视角三层隔离模型)
- **🔬 研究人
  员**：[一、系统自我感知：从观测到认知的跃迁](#一系统自我感知从观测到认知的跃迁)
  → [五、未来演进：从智能到自治](#五未来演进从智能到自治) →
  [六、最新技术栈前沿：eBPF + OTLP 的未来演进](#六最新技术栈前沿ebpf--otlp-的未来演进)

### 📚 按主题快速跳转

- **eBPF 技术栈**：[一、eBPF 技术堆栈全景解析](#一ebpf-技术堆栈全景解析)
- **OTLP 技术栈**：[二、OTLP 技术堆栈全景解析](#二otlp-技术堆栈全景解析)
- **技术对比**：[三、技术堆栈对比论证](#三技术堆栈对比论证)
- **协同关系**：[四、协同关系深度分析](#四协同关系深度分析)
- **智能系
  统**：[eBPF 与 OTLP 技术栈下的智能系统能力架构](#ebpf-与-otlp-技术栈下的智能系统能力架构)
- **架构视
  角**：[二、虚拟化/容器化/沙盒化架构视角：三层隔离模型](#二虚拟化容器化沙盒化架构视角三层隔离模型)
- **未来演进**：[五、未来演进：从智能到自治](#五未来演进从智能到自治)

### 🚀 快速开始（5 分钟）

1. 阅读 [一、eBPF 技术堆栈全景解析](#一ebpf-技术堆栈全景解析) 了解 eBPF 核心架构
2. 查看 [二、OTLP 技术堆栈全景解析](#二otlp-技术堆栈全景解析) 了解 OTLP 协议规范
3. 参考
   [一、系统自我感知：从观测到认知的跃迁](#一系统自我感知从观测到认知的跃迁) 理
   解智能系统能力架构
...
- **[13. eBPF/OTLP 认知视角](../docs/COGNITIVE/04-application-perspectives/ebpf-otlp-perspective/ebpf-otlp-perspective.md)**
  ⭐ - eBPF/OTLP 认知视角分析文档（理念层、知识结构、技术演进）
- **[32. eBPF/OTLP 扩展技术分析](../docs/TECHNICAL/08-architecture-analysis/ebpf-otlp-analysis/ebpf-otlp-analysis.md)**
  ⭐ - eBPF/OTLP 扩展技术分析文档（架构设计、性能分析、实践指南）
- **[31. eBPF 技术堆栈](../docs/TECHNICAL/04-infrastructure-stack/ebpf-stack/ebpf-stack.md)** - eBPF 技
  术堆栈完整技术参考文档
  - [31.6.5 eBPF 与 OpenTelemetry 集成](../docs/TECHNICAL/04-infrastructure-stack/ebpf-stack/ebpf-stack.md#3165-ebpf-与-opentelemetry-集成)
  - [31.6.5.1 横纵耦合定位模型](../docs/TECHNICAL/04-infrastructure-stack/ebpf-stack/ebpf-stack.md#31651-横纵耦合定位模型)
- **[29. 隔离栈](../docs/TECHNICAL/08-architecture-analysis/isolation-stack/isolation-stack.md)** - 问题
  定位模型、横纵耦合定位方法
  - [29.6 问题定位模型](../docs/TECHNICAL/08-architecture-analysis/isolation-stack/isolation-stack.md#296-问题定位模型横向请求链--纵向隔离栈)
  - [29.6.12 网络定位专题](../docs/TECHNICAL/08-architecture-analysis/isolation-stack/isolation-stack.md#29612-网络定位专题横向生命线)
- **[16. 监控与可观测性](../docs/TECHNICAL/04-infrastructure-stack/observability/observability.md)** -
  OTLP、OpenTelemetry、eBPF 等技术规范
- **[30. 概念关系矩阵 - 可观测性属性](../docs/TECHNICAL/08-architecture-analysis/concept-relations-matrix/properties/observability-properties.md)** -
