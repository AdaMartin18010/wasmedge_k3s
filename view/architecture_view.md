...
- [从软件架构的视角看待虚拟化容器化沙盒化](#从软件架构的视角看待虚拟化容器化沙盒化)
  ...
  - [🧠 认知增强：思维导图、知识矩阵与专家观点](#-认知增强思维导图知识矩阵与专家观点)
    ...
    - [11.4 形象化解释论证](#114-形象化解释论证)
      - [11.4.1 统一中层模型 ℳ = 云原生的"中间语言"](#1141-统一中层模型-ℳ--云原生的中间语言)
    ...
    - [11.5 专家观点与论证](#115-专家观点与论证)
      - [11.5.1 软件架构专家的观点](#1151-软件架构专家的观点)
        ...
        - [2. Robert C. Martin（Clean Architecture 作者）](#2-robert-c-martinclean-architecture-作者)
      - [11.5.2 云原生架构专家的观点](#1152-云原生架构专家的观点)
        - [1. Kelsey Hightower（Kubernetes 专家）](#1-kelsey-hightowerkubernetes-专家)
        - [2. Brendan Burns（Kubernetes 联合创始人）](#2-brendan-burnskubernetes-联合创始人)
      - [11.5.3 分布式系统专家的观点](#1153-分布式系统专家的观点)
        - [1. Leslie Lamport（分布式系统理论家）](#1-leslie-lamport分布式系统理论家)
        - [2. Pat Helland（分布式系统专家）](#2-pat-helland分布式系统专家)
