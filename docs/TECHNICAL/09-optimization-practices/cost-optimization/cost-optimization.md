...
> **💡 隔离层次关联**：不同隔离层次的资源占用和成本差异很大（L-4 WASM 资源占用最
> 少，L-3 容器次之，L-1 VM 最多）。详细的技术解析和对比请参考：
>
...
>   容器资源管理
> - **[L-4 沙盒化层](../29-isolation-stack/layers/L-4-sandboxing.md)** - WASM 资
>   源优化
...
- **[29. 隔离栈](../29-isolation-stack/isolation-stack.md)** - 完整的隔离栈技术
  解析，包括资源占用对比
- **[隔离层次对比文档](../29-isolation-stack/layers/isolation-comparison.md)** -
  性能对比矩阵、资源占用对比、成本维度选型
- **[L-3 容器化层](../29-isolation-stack/layers/L-3-containerization.md)** - 容
  器资源管理和优化
- **[L-4 沙盒化层](../29-isolation-stack/layers/L-4-sandboxing.md)** - WASM 资源
  优化（最低资源占用）
