...
- **[27. 2025 趋势 - 2025-11-06 最新更新](../27-2025-trends/2025-trends.md#2714-2025-年-11-月-6-日最新更新)** -
  ...
  - **性能提升**：推理延迟比 PyTorch 容器 ↓60%
  - **Llama2/7B 插件**：内置 Llama2 插件，张量算子直接调用 GPU 驱动
  - **模型 Wasm-化**：".wasm 模型镜像"格式，镜像体积仅为 Python 容器 1/10
  - **GPU 加速推理**：支持 CUDA、OpenCL 后端，推理延迟比容器化 PyTorch ↓60%
