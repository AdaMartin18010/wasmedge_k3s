...
- [03. WasmEdge：WebAssembly 运行时集成指南](#03-wasmedgewebassembly-运行时集成指南)
  - [📑 目录](#-目录)
  - [03.1 文档定位](#031-文档定位)
  - [03.2 核心定位](#032-核心定位)
...
- **[27. 2025 趋势 - 2025-11-06 最新更新](../27-2025-trends/2025-trends.md#2714-2025-年-11-月-6-日最新更新)** -
  完整的技术版本更新、生产环境最佳实践、已知问题与解决方案、**性能基准测试**（包
  含边缘节点、云数据中心、多场景对比）、**生产环境案例**（包括浪潮云边缘计算平台
  案例）、技术发展趋势更新
  - **[27.14.4 性能基准测试](../27-2025-trends/2025-trends.md#27144-性能基准测试2025-11-06)** -
    包含边缘节点性能对比、云数据中心性能对比、多场景性能基准测试矩阵（2025-11-06
    最新数据）
  - **[27.14.5.1 大规模边缘节点部署案例](../27-2025-trends/2025-trends.md#271451-大规模边缘节点部署案例)** -
    浪潮云边缘计算平台（10 万台边缘节点）生产环境案例
  - **[27.14.7 技术发展趋势更新](../27-2025-trends/2025-trends.md#27147-技术发展趋势更新2025-11-06)** -
    包含 WasmEdge 0.14.1 发布和技术演进预测
