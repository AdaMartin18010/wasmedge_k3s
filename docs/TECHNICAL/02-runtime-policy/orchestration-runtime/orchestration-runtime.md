...
- [04. 编排与运行时集成：CRI 与 RuntimeClass](#04-编排与运行时集成cri-与-runtimeclass)
  - [📑 目录](#-目录)
  - [04.1 文档定位](#041-文档定位)
...
> **💡 隔离层次关联**：不同的运行时类型对应隔离栈的不同层次。runc 属于 L-3 容器
> 化层，crun/runwasi（Wasm）属于 L-4 沙盒化层。详细的技术解析请参考：
>
...
- **[11. 故障排查](../11-troubleshooting/troubleshooting.md)** - 运行时故障排查
  方法
- **[22. 升级迁移](../22-upgrade-migration/upgrade-migration.md)** - 运行时迁移
  相关内容
...
- **[05. 全局架构设计](../../COGNITIVE/02-architecture-design/architecture-design/architecture-design.md)** -
  技术组合和架构决策
- **[09. 矩阵视角](../../COGNITIVE/03-theoretical-perspectives/matrix-perspective/README.md)** - 运行时切
  换（R）概念矩阵分析
