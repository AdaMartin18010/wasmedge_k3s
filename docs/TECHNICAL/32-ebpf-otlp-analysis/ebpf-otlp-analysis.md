...
- [32.1 技术规范与语义模型对齐](#321-技术规范与语义模型对齐从底层到协议的精密映射)
- [32.2 虚拟化/容器化/沙盒化架构视角](#322-虚拟化容器化沙盒化架构视角三层隔离模型)
- [32.3 思维导图](#323-思维导图ebpf-otlp-融合架构全景)
- [32.4 知识图谱](#324-知识图谱实体关系与语义关联)
- [32.5 多维矩阵视角](#325-多维矩阵视角性能-安全-可移植性-语义的权衡空间)
- [32.6 性能基准测试](#326-性能基准测试详细性能数据和对比分析)
- [32.7 优化策略](#327-优化策略内核态预聚合列式编码批处理)
- [32.8 部署架构](#328-部署架构生产级实践架构设计)
- [32.9 安全与权限管理](#329-安全与权限管理零信任架构设计)
- [32.10 故障排查](#3210-故障排查常见问题与解决方案)
- [32.11 最佳实践](#3211-最佳实践生产环境最佳实践总结)
- [32.12 智能系统能力架构](#3212-智能系统能力架构从观测到自治的技术演进)
- [32.13 最新技术栈前沿](#3213-最新技术栈前沿ebpf--otlp-的未来演进)
- [32.14 虚拟化/容器化融合架构](#3214-虚拟化容器化融合架构ebpf-as-a-service-eaas)
- [32.15 总结](#3215-总结ebpf--otlp-技术栈的核心价值)
...
- **[13. eBPF/OTLP 认知视角](../../COGNITIVE/13-ebpf-otlp-perspective/ebpf-otlp-perspective.md)** -
  认知视角分析文档
- **[01. 总览](../../COGNITIVE/01-overview/overview.md)** - 技术栈总览和决策框架
