...
- [12. 网络技术规格堆栈：全面梳理](#12-网络技术规格堆栈全面梳理)
  - [📑 目录](#-目录)
  - [12.1 文档定位](#121-文档定位)
  ...
  - [12.18 虚拟化与容器化网络对比分析](#1218-虚拟化与容器化网络对比分析)
...
> 📋 **eBPF 技术详解**：Cilium 基于 eBPF 实现高性能网络加速，详细技术原理、性能
> 对比和最佳实践请参考
> [31. eBPF 技术堆栈](../31-ebpf-stack/ebpf-stack.md#315-ebpf-在网络中的应用)。
...
> 📋 **eBPF 网络策略详解**：Cilium NetworkPolicy 基于 eBPF 实现高性能网络策略执
> 行，详细技术原理和性能对比请参考
> [31. eBPF 技术堆栈](../31-ebpf-stack/ebpf-stack.md#315-ebpf-在网络中的应用) 和
> [31.8 eBPF 在安全中的应用](../31-ebpf-stack/ebpf-stack.md#318-ebpf-在安全中的应用)。
...
> 📋 **补充文档**：详细的虚拟化与容器化网络技术对比分析，包含范式转换、架构差异
> 、性能对比、选型决策等完整内容。

**文档位置**：[虚拟化与容器化网络对比分析](./virtualization-comparison.md)
