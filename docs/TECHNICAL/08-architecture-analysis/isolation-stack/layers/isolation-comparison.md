...
- [隔离层次总结合并对比文档](#隔离层次总结合并对比文档)
  ...
  - [2 隔离层次快速对比](#2-隔离层次快速对比)
    - [2.1 核心属性对比](#21-核心属性对比)
    - [2.2 技术实现对比](#22-技术实现对比)
    - [2.3 应用场景对比](#23-应用场景对比)
  - [3 详细对比矩阵](#3-详细对比矩阵)
    - [3.1 性能维度选型](#31-性能维度选型)
    - [3.2 安全维度选型](#32-安全维度选型)
    - [3.3 成本维度选型](#33-成本维度选型)
  - [4 技术选型决策树](#4-技术选型决策树)
    - [4.1 启动速度优先](#41-启动速度优先)
    - [4.2 隔离强度优先](#42-隔离强度优先)
    - [4.3 资源利用率优先](#43-资源利用率优先)
  - [5 应用场景匹配](#5-应用场景匹配)
    - [5.1 边缘计算场景](#51-边缘计算场景)
    - [5.2 微服务场景](#52-微服务场景)
    - [5.3 Serverless 场景](#53-serverless-场景)
    - [5.4 企业级合规场景](#54-企业级合规场景)
  - [6 混合部署策略](#6-混合部署策略)
    - [6.1 混合部署模式](#61-混合部署模式)
    - [6.2 混合部署架构](#62-混合部署架构)
  - [7 参考文档链接](#7-参考文档链接)
    - [7.1 各层次详细文档](#71-各层次详细文档)
    - [7.2 相关文档](#72-相关文档)
    - [7.3 快速检索指南](#73-快速检索指南)
  - [8 快速导航指南](#8-快速导航指南)
    - [8.1 按使用场景快速选择](#81-按使用场景快速选择)
    - [8.2 按技术需求快速选择](#82-按技术需求快速选择)
    - [8.3 按技术组件快速定位](#83-按技术组件快速定位)
    - [8.4 快速参考卡片](#84-快速参考卡片)
  - [9 常见问题 FAQ](#9-常见问题-faq)
    - [9.1 技术选型相关问题](#91-技术选型相关问题)
      - [Q1: 如何快速选择最适合的隔离层次？](#q1-如何快速选择最适合的隔离层次)
      - [Q2: 可以混合使用多个隔离层次吗？](#q2-可以混合使用多个隔离层次吗)
      - [Q3: 性能开销如何评估？](#q3-性能开销如何评估)
    - [9.2 安全相关问题](#92-安全相关问题)
      - [Q4: 容器逃逸的风险有多大？](#q4-容器逃逸的风险有多大)
      - [Q5: 如何提升容器安全性？](#q5-如何提升容器安全性)
    - [9.3 性能相关问题](#93-性能相关问题)
      - [Q6: 如何优化虚拟化性能？](#q6-如何优化虚拟化性能)
      - [Q7: WASM 性能如何？](#q7-wasm-性能如何)
    - [9.4 故障排查相关问题](#94-故障排查相关问题)
      - [Q8: 如何快速定位隔离层次问题？](#q8-如何快速定位隔离层次问题)
      - [Q9: 容器无法启动怎么办？](#q9-容器无法启动怎么办)
    - [9.5 迁移相关问题](#95-迁移相关问题)
      - [Q10: 如何从 VM 迁移到容器？](#q10-如何从-vm-迁移到容器)
  - [10 故障排查快速参考](#10-故障排查快速参考)
    - [10.1 诊断命令速查](#101-诊断命令速查)
    - [10.2 日志关键词定位](#102-日志关键词定位)
    - [10.3 性能问题排查](#103-性能问题排查)
  - [11 相关文档快速链接](#11-相关文档快速链接)
    - [11.1 各层次独立文档](#111-各层次独立文档)
    - [11.2 主文档相关章节](#112-主文档相关章节)
    - [11.3 其他技术文档](#113-其他技术文档)
