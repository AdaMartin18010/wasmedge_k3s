...
- [30. 2025 技术堆栈概念关系矩阵与多维关系分析](#30-2025-技术堆栈概念关系矩阵与多维关系分析)
  - [📑 目录](#-目录)
  - [30.1 文档定位](#301-文档定位)
  ...
  - [30.22 参考](#3022-参考)
    - [30.22.1 系统分析文档](#30221-系统分析文档)
    - [30.22.2 相关文档](#30222-相关文档)
    - [30.22.3 外部资源](#30223-外部资源)
    - [30.22.4 技术标准](#30224-技术标准)
...
- **[系统分析视角](../../../systems_view.md)** ⭐ - 从系统分析看虚拟化容器化沙盒
  化 Wasm，多维度矩阵对比和形式化论证，提供更深入的系统分析和性能模型
- **[系统视角文档](../../../system_view.md)** ⭐ - 从系统的视角看虚拟化容器化沙
  盒化（7 层 4 域模型），提供系统层面的技术选型指导
- **[隔离栈技术实现](../29-isolation-stack/isolation-stack.md)** ⭐ - 四层隔离栈
  详细解析，横纵耦合问题定位模型
...
属性关系矩阵从四个维度对比了不同技术的特性：

- **性能属性**：对比 VM、容器、Wasm 在冷启动、内存、CPU、镜像大小等方面的性能表
  现
- **安全属性**：对比不同技术的隔离强度、攻击面、加密、审计、合规和零信任能力
- **可扩展性属性**：对比 K8s、K3s、WasmEdge 在水平扩展、垂直扩展、资源利用率等方
  面的能力
- **可观测性属性**：对比 Prometheus、Loki、Jaeger、OTLP、eBPF 在
  Metrics、Logs、Traces 等方面的能力
