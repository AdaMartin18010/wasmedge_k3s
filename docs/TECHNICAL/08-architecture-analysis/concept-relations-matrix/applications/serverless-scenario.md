...
- [Serverless 场景](#serverless-场景)
  ...
  - [12. 2025 年最新实践](#12-2025-年最新实践)
    ...
    - [12.2 Serverless 优化](#122-serverless-优化)
    - [12.3 边缘 Serverless](#123-边缘-serverless)
  - [13. 实际应用案例](#13-实际应用案例)
    - [案例 1：大规模 Serverless 平台](#案例-1大规模-serverless-平台)
    - [案例 2：API 网关 Serverless](#案例-2api-网关-serverless)
    - [案例 3：事件处理 Serverless](#案例-3事件处理-serverless)
  - [7. 参考文档](#7-参考文档)
    - [7.1 技术文档](#71-技术文档)
    - [7.2 实践案例](#72-实践案例)
    - [7.3 外部资源](#73-外部资源)
...
### 案例 2：API 网关 Serverless

**场景**：API 网关的 Serverless 函数服务
...
### 案例 3：事件处理 Serverless

**场景**：事件驱动的 Serverless 函数服务
