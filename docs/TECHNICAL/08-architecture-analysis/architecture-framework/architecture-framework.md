...
- [28. 架构框架：多维度架构体系与技术规范](#28-架构框架多维度架构体系与技术规范)
  - [📑 目录](#-目录)
  - [28.1 文档定位](#281-文档定位)
  ...
  - [28.11 参考](#2811-参考)
    ...
    - [28.11.3.1 2025 年最新更新（2025-11-06）](#281131-2025-年最新更新2025-11-06)
    - [28.11.3.2 隔离栈相关文档](#281132-隔离栈相关文档)
    - [28.11.3.3 架构相关文档](#281133-架构相关文档)
    - [28.11.3 虚拟化与容器化对比分析](#28113-虚拟化与容器化对比分析)
    - [28.11.4 eBPF 技术堆栈相关文档](#28114-ebpf-技术堆栈相关文档)
  - [2025 年最新实践](#2025-年最新实践)
    - [架构框架应用最佳实践（2025）](#架构框架应用最佳实践2025)
  - [实际应用案例](#实际应用案例)
...
> **💡 隔离层次关联**：容器运行时层涉及 L-3 容器化层（runc、containerd、crun）和
> L-4 沙盒化层（WasmEdge）。详细的技术解析请参考：
>
...
### 28.11.3.1 2025 年最新更新（2025-11-06）
...
- **[27. 2025 趋势 - 2025-11-06 最新更新](../27-2025-trends/2025-trends.md#2714-2025-年-11-月-6-日最新更新)** -
  ...
  - **架构演进**：云原生架构持续演进，RuntimeClass=wasm 原生支持

**架构框架最佳实践（2025-11-06）**：

- **技术架构**：优先使用 RuntimeClass=wasm 原生支持，K3s `--wasm` flag 即开即用
- **概念架构**：采用 WasmEdge 边缘计算模式，冷启动 <10 ms，内存占用 <32 MB
- **数据架构**：OTLP + eBPF 联合数据采集，提供横纵耦合的可观测性
...
- **[虚拟化与容器化网络对比分析](../12-network-stack/virtualization-comparison.md)** -
  网络架构对比、范式转换分析、选型决策（2025-11-07）
- **[虚拟化与容器化存储对比分析](../15-storage-stack/virtualization-comparison.md)** -
  存储架构对比、范式转换分析、选型决策（2025-11-07）

### 28.11.4 eBPF 技术堆栈相关文档
