...
- [WasmEdge 边缘部署](#wasmedge-边缘部署)
  - [📑 目录](#-目录)
  - [1 概述](#1-概述)
    - [1.1 核心特性](#11-核心特性)
  - [2 WasmEdge 安装](#2-wasmedge-安装)
    - [2.1 边缘节点安装](#21-边缘节点安装)
    - [2.2 containerd Wasm shim 安装](#22-containerd-wasm-shim-安装)
  - [3 Kubernetes 集成](#3-kubernetes-集成)
    - [3.1 RuntimeClass 配置](#31-runtimeclass-配置)
    - [3.2 K3s WasmEdge 支持](#32-k3s-wasmedge-支持)
  - [4 边缘 AI 推理](#4-边缘-ai-推理)
    - [4.1 WasmEdge AI 安装](#41-wasmedge-ai-安装)
    - [4.2 边缘 AI 推理 Pod](#42-边缘-ai-推理-pod)
  - [5 相关文档](#5-相关文档)
...
**WasmEdge** 是云原生 WebAssembly 运行时，特别适合边缘计算场景，提供极速启动和极
轻量的特性。
...
- [`../../06-wasm/wasmedge-setup.md`](../../06-wasm/wasmedge-setup.md) -
  WasmEdge 详细配置
