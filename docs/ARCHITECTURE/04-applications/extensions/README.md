...
- [3 核心主题](#3-核心主题)
  - [3.1 边缘计算](#31-边缘计算)
  - [3.2 无服务器（Serverless）](#32-无服务器serverless)
  - [3.3 AI 推理](#33-ai-推理)
  - [3.4 多租户](#34-多租户)
- [4 技术选型指南](#4-技术选型指南)
  - [4.1 边缘计算选型](#41-边缘计算选型)
  - [4.2 无服务器选型](#42-无服务器选型)
  - [4.3 AI 推理选型](#43-ai-推理选型)
  - [4.4 多租户选型](#44-多租户选型)
- [5 实施案例](#5-实施案例)
  - [5.1 边缘计算案例](#51-边缘计算案例)
  - [5.2 无服务器案例](#52-无服务器案例)
  - [5.3 AI 推理案例](#53-ai-推理案例)
  - [5.4 多租户案例](#54-多租户案例)
- [6 最佳实践](#6-最佳实践)
  - [6.1 边缘计算最佳实践](#61-边缘计算最佳实践)
  - [6.2 无服务器最佳实践](#62-无服务器最佳实践)
  - [6.3 AI 推理最佳实践](#63-ai-推理最佳实践)
  - [6.4 多租户最佳实践](#64-多租户最佳实践)
- [7 相关文档](#7-相关文档)
  - [7.1 拓展场景文档](#71-拓展场景文档)
  - [7.2 技术更新文档](#72-技术更新文档)
  - [7.3 源文档](#73-源文档)
- [8 总结](#8-总结)
...
本目录文档与 `../../02-views/06-concepts-properties-relations/04-extensions.md`
和 `../../02-views/10-november-2025-updates/` 目录对应，提供更详细的拓展应用内容
。

### 2.1 核心文档

- **拓展场
  景**：`../../02-views/06-concepts-properties-relations/04-extensions.md` - 拓
  展场景详细文档
- **技术更新**：`../../02-views/10-november-2025-updates/` - 最新技术更新和最佳
  实践
