...
本目录文档与
`../../02-views/06-concepts-properties-relations/04-extensions.md` 和
`../../02-views/10-november-2025-updates/` 目录对应，提供更详细的拓展应用内容
。

### 2.1 核心文档

- **拓展场
  景**：`../../02-views/06-concepts-properties-relations/04-extensions.md` -
  拓展场景详细文档
- **技术更新**：`../../02-views/10-november-2025-updates/` - 最新技术更新和最
  佳实践
