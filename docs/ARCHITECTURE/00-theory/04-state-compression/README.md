...
- [状态空间压缩文档集](#状态空间压缩文档集)
  ...
  - [8 认知增强：思维导图、知识矩阵与专家观点](#8-认知增强思维导图知识矩阵与专家观点)
    - [8.1 状态空间压缩完整思维导图](#81-状态空间压缩完整思维导图)
    - [8.2 知识多维关系矩阵](#82-知识多维关系矩阵)
      - [状态空间压缩多维关系矩阵](#状态空间压缩多维关系矩阵)
      - [压缩应用多维关系矩阵](#压缩应用多维关系矩阵)
    - [8.3 形象化解释论证](#83-形象化解释论证)
      - [状态空间压缩的形象化类比](#状态空间压缩的形象化类比)
        - [1. 状态空间压缩 = 数据压缩算法](#1-状态空间压缩--数据压缩算法)
        - [2. 五次压缩 = 五层过滤网](#2-五次压缩--五层过滤网)
        - [3. 压缩比 = 地图缩放比例](#3-压缩比--地图缩放比例)
        - [4. 统一模型 = 通用接口](#4-统一模型--通用接口)
    - [8.4 专家观点与论证](#84-专家观点与论证)
      - [计算信息软件科学家的观点](#计算信息软件科学家的观点)
        - [1. Claude Shannon（信息论创始人）](#1-claude-shannon信息论创始人)
        - [2. Alan Turing（计算理论创始人）](#2-alan-turing计算理论创始人)
        - [3. John von Neumann（计算机架构创始人）](#3-john-von-neumann计算机架构创始人)
      - [计算信息软件教育家的观点](#计算信息软件教育家的观点)
        - [1. Donald Knuth（算法教育家）](#1-donald-knuth算法教育家)
        - [2. Edsger Dijkstra（程序设计教育家）](#2-edsger-dijkstra程序设计教育家)
