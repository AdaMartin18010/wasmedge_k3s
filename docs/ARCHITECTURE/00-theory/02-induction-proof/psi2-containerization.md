...
- [Ψ₂：第二次归纳映射（容器化层）](#ψ第二次归纳映射容器化层)
  ...
  - [4 状态空间压缩](#4-状态空间压缩)
    - [4.1 镜像大小压缩](#41-镜像大小压缩)
    - [4.2 启动时间压缩](#42-启动时间压缩)
    - [4.3 资源粒度细化](#43-资源粒度细化)
  - [5 关键引理 L1](#5-关键引理-l1)
    - [5.1 引理描述](#51-引理描述)
    - [5.2 引理意义](#52-引理意义)
    - [5.3 详细文档](#53-详细文档)
  - [6 实证验证](#6-实证验证)
    - [6.1 Alibaba 2022 双 11 压测](#61-alibaba-2022-双-11-压测)
    - [6.2 镜像大小和启动时间](#62-镜像大小和启动时间)
  - [7 架构收益](#7-架构收益)
    - [7.1 计算单元降维](#71-计算单元降维)
    - [7.2 架构图版本化](#72-架构图版本化)
    - [7.3 资源粒度细化](#73-资源粒度细化)
  - [8 遗留问题](#8-遗留问题)
    - [8.1 问题一：安全边界不够细](#81-问题一安全边界不够细)
    - [8.2 问题二：状态空间仍可压缩](#82-问题二状态空间仍可压缩)
  - [9 相关文档](#9-相关文档)
    - [9.1 归纳证明文档](#91-归纳证明文档)
    - [9.2 引理和定理文档](#92-引理和定理文档)
    - [9.3 公理层文档](#93-公理层文档)
    - [9.4 状态空间压缩文档](#94-状态空间压缩文档)
    - [9.5 源文档](#95-源文档)
