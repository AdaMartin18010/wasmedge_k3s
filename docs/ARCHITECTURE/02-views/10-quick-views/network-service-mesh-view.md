...
- [Network Service Mesh (NSM) 架构视角](#network-service-mesh-nsm-架构视角)
  - [📑 目录](#-目录)
  - [1 目标与视角](#1-目标与视角)
    - [核心思想](#核心思想)
  - [2 关键概念](#2-关键概念)
  ...
  - [4 组合模式与技术实现](#4-组合模式与技术实现)
    - [4.1 组合 Service Mesh 作为 Network Service](#41-组合-service-mesh-作为-network-service)
    - [4.2 组合多云/跨集群网络](#42-组合多云跨集群网络)
  - [5 设计论证](#5-设计论证)
    - [5.1 为什么要把 Service Mesh 作为"网络服务"](#51-为什么要把-service-mesh-作为网络服务)
    - [5.2 组合网络服务的典型用例](#52-组合网络服务的典型用例)
  - [6 典型实现步骤](#6-典型实现步骤)
    - [6.1 准备工作](#61-准备工作)
    - [6.2 注册网络服务](#62-注册网络服务)
    - [6.3 为业务 Pod 创建 Client](#63-为业务-pod-创建-client)
    - [6.4 建立 vWire](#64-建立-vwire)
    - [6.5 验证 \& 监控](#65-验证--监控)
    - [6.6 安全与治理](#66-安全与治理)
  - [7 最佳实践](#7-最佳实践)
  - [8 关键论证点](#8-关键论证点)
    - [8.1 可组合性](#81-可组合性)
    - [8.2 抽象层次](#82-抽象层次)
    - [8.3 弹性与多租户](#83-弹性与多租户)
    - [8.4 安全统一](#84-安全统一)
    - [8.5 观测统一](#85-观测统一)
  - [9 架构设计范式的反向重塑](#9-架构设计范式的反向重塑)
    - [9.1 从"分层图"到"过滤器图"](#91-从分层图到过滤器图)
    - [9.2 非功能性从"后期治理"变为"设计期可组合元素"](#92-非功能性从后期治理变为设计期可组合元素)
  - [10 总结](#10-总结)
    - [核心价值](#核心价值)
  - [11 参考资源](#11-参考资源)
    - [相关文档](#相关文档)
...
- **[NSM 架构详细文档](../../03-service-mesh-nsm/04-nsm-architecture.md)** -
  NSM 架构的详细说明
- **[Service Mesh 详细文档集](../../03-service-mesh-nsm/)** -
...
- `../08-composition-patterns/05-nsm-pattern.md` - NSM 模式详细说
  明
- `../08-composition-patterns/05-nsm-pattern.md#service-aggregation` -
