...
- **[动态运维详细文档集](../07-dynamic-operations/)** - 包含
  GitOps、可观测性、弹性伸缩、CI/CD、混沌工程等详细内容
  - [GitOps](../07-dynamic-operations/01-gitops.md)
  - [可观测性](../07-dynamic-operations/02-observability.md)
  - [弹性伸缩](../07-dynamic-operations/03-autoscaling.md)
  - [CI/CD](../07-dynamic-operations/04-ci-cd.md)
  - [混沌工程](../07-dynamic-operations/05-chaos-engineering.md)
