...
- [4 虚拟化的形式化描述](#4-虚拟化的形式化描述)
  - [4.1 计算机模型](#41-计算机模型)
  - [4.2 状态压缩](#42-状态压缩)
- [5 虚拟化 vs 容器化 vs 沙盒化](#5-虚拟化-vs-容器化-vs-沙盒化)
- [6 虚拟化的组合模式](#6-虚拟化的组合模式)
  - [6.1 与容器化的组合](#61-与容器化的组合)
  - [6.2 与沙盒化的组合](#62-与沙盒化的组合)
  - [6.3 与 Service Mesh 的组合](#63-与-service-mesh-的组合)
- [7 典型案例：支付网关](#7-典型案例支付网关)
- [8 2025 年虚拟化趋势](#8-2025-年虚拟化趋势)
  - [8.1 轻量化虚拟机](#81-轻量化虚拟机)
  - [8.2 机密计算](#82-机密计算)
  - [8.3 边缘虚拟化](#83-边缘虚拟化)
- [9 最佳实践](#9-最佳实践)
  - [9.1 虚拟化选型](#91-虚拟化选型)
...
- **相关文档**：
  ...
  - `../../04-applications/case-studies/payment-gateway.md` - 支付网关案例（包含虚拟化实践）
