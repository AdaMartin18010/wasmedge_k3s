...
- [5. Service Mesh 与 NSM 的组合](#5-service-mesh-与-nsm-的组合)
  - [5.1 组合 Service Mesh 作为 Network Service](#51-组合-service-mesh-作为-network-service)
  - [5.2 组合多云/跨集群网络](#52-组合多云跨集群网络)
- [6. Service Mesh 的类型](#6-service-mesh-的类型)
  - [6.1 Istio](#61-istio)
  - [6.2 Linkerd](#62-linkerd)
  - [6.3 Consul Connect](#63-consul-connect)
  - [6.4 Kuma](#64-kuma)
- [7. 2025 年 Service Mesh 趋势](#7-2025-年-service-mesh-趋势)
  - [7.1 轻量化](#71-轻量化)
  - [7.2 边缘计算](#72-边缘计算)
  - [7.3 多集群/多云](#73-多集群多云)
- [8. 典型案例](#8-典型案例)
...
### 5.1 组合 Service Mesh 作为 Network Service
