...
- [3. 沙盒化的形式化描述](#3-沙盒化的形式化描述)
  - [3.1 沙盒定义](#31-沙盒定义)
  - [3.2 能力闭包](#32-能力闭包)
- [4. 沙盒技术分类](#4-沙盒技术分类)
  - [4.1 系统调用过滤](#41-系统调用过滤)
  ...
  - [4.3 WebAssembly (WASI)](#43-webassembly-wasi)
    - [WASM + WASI](#wasm--wasi)
  - [4.4 文件系统隔离](#44-文件系统隔离)
    - [Landlock](#landlock)
    - [AppArmor / SELinux](#apparmor--selinux)
- [5. 沙盒化 vs 容器化](#5-沙盒化-vs-容器化)
- [6. 沙盒与 OPA 的组合](#6-沙盒与-opa-的组合)
  - [6.1 双层闸门](#61-双层闸门)
  - [6.2 形式化描述](#62-形式化描述)
  - [6.3 实证](#63-实证)
- [7. 沙盒与 Service Mesh 的组合](#7-沙盒与-service-mesh-的组合)
  - [7.1 统一安全模型](#71-统一安全模型)
  - [7.2 组合方式](#72-组合方式)
- [8. 典型案例](#8-典型案例)
  - [8.1 代码执行沙盒](#81-代码执行沙盒)
  - [8.2 CI/CD 沙盒](#82-cicd-沙盒)
  - [8.3 多租户 SaaS](#83-多租户-saas)
- [9. 2025 年沙盒化趋势](#9-2025-年沙盒化趋势)
  - [9.1 机密容器](#91-机密容器)
  - [9.2 eBPF 增强](#92-ebpf-增强)
  - [9.3 WebAssembly 运行时](#93-webassembly-运行时)
- [10. 安全基准](#10-安全基准)
