...
- [1. 概述](#1-概述)
- [2. 核心模式](#2-核心模式)
  - [2.1 Git 作为单一事实来源](#21-git-作为单一事实来源)
  - [2.2 声明式配置模式](#22-声明式配置模式)
  - [2.3 自动化同步模式](#23-自动化同步模式)
- [3. 技术实现](#3-技术实现)
  - [3.1 ArgoCD](#31-argocd)
  - [3.2 Flux](#32-flux)
  - [3.3 Jenkins X](#33-jenkins-x)
- [4. 模式对比矩阵](#4-模式对比矩阵)
- [5. 组合模式](#5-组合模式)
  - [5.1 GitOps + Service Mesh](#51-gitops--service-mesh)
  - [5.2 GitOps + OPA](#52-gitops--opa)
  - [5.3 GitOps + Infrastructure as Code](#53-gitops--infrastructure-as-code)
- [6. 演进路径](#6-演进路径)
...
### 5.3 GitOps + Infrastructure as Code
