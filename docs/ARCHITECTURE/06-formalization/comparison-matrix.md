...
- [2. Service Mesh 对比](#2-service-mesh-对比)
- [3. 容器运行时对比](#3-容器运行时对比)
- [4. 沙盒技术对比](#4-沙盒技术对比)
- [5. 策略治理工具对比](#5-策略治理工具对比)
- [6. 可观测性工具对比](#6-可观测性工具对比)
- [7. GitOps 工具对比](#7-gitops-工具对比)
- [8. 编排工具对比](#8-编排工具对比)
- [9. 网络服务网格对比](#9-网络服务网格对比)
- [10. 状态空间压缩对比](#10-状态空间压缩对比)
- [11. 技术选型决策矩阵](#11-技术选型决策矩阵)
  - [11.1 虚拟化选型](#111-虚拟化选型)
  - [11.2 Service Mesh 选型](#112-service-mesh-选型)
  - [11.3 策略治理选型](#113-策略治理选型)
- [12. 性能基准对比](#12-性能基准对比)
  - [12.1 启动时间](#121-启动时间)
  - [12.2 资源消耗](#122-资源消耗)
  - [12.3 网络延迟](#123-网络延迟)
