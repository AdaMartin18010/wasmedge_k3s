...
- [2025 年 11 月 4 日专题文档](#2025-年-11-月-4-日专题文档)
  - [📑 目录](#-目录)
  - [概述](#概述)
  - [文档结构](#文档结构)
    - [1. 核心主题深化 (`01-core-themes/`)](#1-核心主题深化-01-core-themes)
    - [2. 形式化论证 (`02-formal-proofs/`)](#2-形式化论证-02-formal-proofs)
    - [3. 概念属性关系 (`03-concepts-relations/`)](#3-概念属性关系-03-concepts-relations)
    - [4. 实证分析 (`04-empirical-analysis/`)](#4-实证分析-04-empirical-analysis)
    - [5. 技术演进路径 (`05-evolution-path/`)](#5-技术演进路径-05-evolution-path)
  - [核心主题](#核心主题)
    - [1. 架构拆解与组合（5 步流程）](#1-架构拆解与组合5-步流程)
    - [2. 虚拟化 → 容器化 → 沙盒化](#2-虚拟化--容器化--沙盒化)
    - [3. Service Mesh 与 NSM](#3-service-mesh-与-nsm)
  ...
  - [实证数据](#实证数据)
    - [Google Borg/Omega（15 年生产数据）](#google-borgomega15-年生产数据)
    - [AWS Lambda（2023 年）](#aws-lambda2023-年)
    - [Alibaba 双 11（2022 年）](#alibaba-双-112022-年)
  - [技术选型矩阵](#技术选型矩阵)
  - [阅读路径](#阅读路径)
    - [快速入门](#快速入门)
    - [深入理解](#深入理解)
...
3. 查看 [案例研究](../../04-applications/case-studies/)
