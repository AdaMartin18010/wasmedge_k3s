...
- **`docs/ARCHITECTURE/`** - 架构视角文档集
  - [多视角架构视图](../../02-views/10-quick-views/) - 从不同视角理解架构
  - [分层架构模型](../../03-models/) - 从硬件到业务的分层抽象
  - [组合模式文档集](../../02-views/08-composition-patterns/) - 架构组合的核心模
    式
  - [形式化理论](../../00-theory/) - 数学基础与理论
  - [概念属性关系](../../02-views/06-concepts-properties-relations/) - 概念、属
    性、关系的系统梳理
