...
- [架构层次](#架构层次)
- [技术实现](#技术实现)
- [Service Mesh 对比矩阵](#service-mesh-对比矩阵)
- [安全模型](#安全模型)
- [与 Network Service Mesh 的关系](#与-network-service-mesh-的关系)
- [节点聚合：从物理地址到身份驱动拓扑](#节点聚合从物理地址到身份驱动拓扑)
- [服务组合：从跨服务流到可编排的本地函数](#服务组合从跨服务流到可编排的本地函数)
- [架构设计范式重塑](#架构设计范式重塑)
- [最佳实践](#最佳实践)
- [参考资源](#参考资源)
