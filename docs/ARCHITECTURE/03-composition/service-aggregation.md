...
- [2. Service Aggregation 核心概念](#2-service-aggregation-核心概念)
  - [2.1 定义](#21-定义)
  - [2.2 核心组件](#22-核心组件)
  - [2.3 与 Facade 模式的区别](#23-与-facade-模式的区别)
- [3. 聚合模式分类](#3-聚合模式分类)
  - [3.1 按聚合方式分类](#31-按聚合方式分类)
  - [3.2 按调用方式分类](#32-按调用方式分类)
- [4. API Gateway 聚合模式](#4-api-gateway-聚合模式)
  - [4.1 模式概述](#41-模式概述)
  - [4.2 架构图](#42-架构图)
  - [4.3 典型实现](#43-典型实现)
    - [4.3.1 Kong API Gateway](#431-kong-api-gateway)
    - [4.3.2 Istio Gateway](#432-istio-gateway)
...
- [6. GraphQL 聚合模式](#6-graphql-聚合模式)
  ...
  - [6.2 架构图](#62-架构图)
  - [6.3 典型实现](#63-典型实现)
    - [6.3.1 Apollo Server](#631-apollo-server)
- [7. Service Mesh 聚合模式](#7-service-mesh-聚合模式)
  - [7.1 模式概述](#71-模式概述)
  - [7.2 Istio VirtualService 聚合](#72-istio-virtualservice-聚合)
  - [7.3 服务组合示例](#73-服务组合示例)
- [8. 典型应用场景](#8-典型应用场景)
  - [8.1 电商平台聚合](#81-电商平台聚合)
  - [8.2 金融系统聚合](#82-金融系统聚合)
- [9. 最佳实践](#9-最佳实践)
  - [9.1 性能优化](#91-性能优化)
  - [9.2 错误处理](#92-错误处理)
  - [9.3 监控与可观测性](#93-监控与可观测性)
- [10. 形式化定义](#10-形式化定义)
  - [10.1 聚合函数定义](#101-聚合函数定义)
  - [10.2 聚合模式形式化](#102-聚合模式形式化)
  - [10.3 范畴论视角](#103-范畴论视角)
- [11. 参考资源](#11-参考资源)
  - [11.1 相关文档](#111-相关文档)
  - [11.2 外部资源](#112-外部资源)
  - [11.3 技术文档](#113-技术文档)
