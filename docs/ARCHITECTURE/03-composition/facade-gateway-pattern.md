...
- [1. 概述](#1-概述)
- [2. 模式定义](#2-模式定义)
  - [2.1 Facade 模式](#21-facade-模式)
  - [2.2 Gateway 模式](#22-gateway-模式)
- [3. 典型应用场景](#3-典型应用场景)
  - [3.1 API 网关](#31-api-网关)
  - [3.2 服务聚合](#32-服务聚合)
  - [3.3 统一鉴权](#33-统一鉴权)
- [4. 形式化描述](#4-形式化描述)
  - [4.1 Facade 形式化](#41-facade-形式化)
  - [4.2 Gateway 形式化](#42-gateway-形式化)
  - [4.3 组合语义](#43-组合语义)
- [5. 架构案例](#5-架构案例)
  - [5.1 案例：电商平台 API 网关](#51-案例电商平台-api-网关)
  - [5.2 案例：GraphQL BFF](#52-案例graphql-bff)
- [6. 组合模式集成](#6-组合模式集成)
  - [6.1 与 Service Mesh 集成](#61-与-service-mesh-集成)
  - [6.2 与 OPA 集成](#62-与-opa-集成)
- [7. 2025 年 11 月最新趋势](#7-2025-年-11-月最新趋势)
  - [7.1 API 网关演进](#71-api-网关演进)
  - [7.2 GraphQL 生态成熟](#72-graphql-生态成熟)
  - [7.3 统一鉴权](#73-统一鉴权)
- [8. 最佳实践](#8-最佳实践)
  - [8.1 设计原则](#81-设计原则)
  - [8.2 实现建议](#82-实现建议)
