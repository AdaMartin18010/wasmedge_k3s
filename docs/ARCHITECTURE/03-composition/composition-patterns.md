...
- [2. 组合模式概述](#2-组合模式概述)
  - [2.1 核心原则](#21-核心原则)
- [3. 组合模式分类](#3-组合模式分类)
- [4. Adapter / Bridge 模式](#4-adapter--bridge-模式)
  - [4.1 跨技术边界](#41-跨技术边界)
  - [4.2 典型案例](#42-典型案例)
...
- [7. Pipeline / Orchestration 模式](#7-pipeline--orchestration-模式)
  - [7.1 流程编排](#71-流程编排)
  - [7.2 典型案例](#72-典型案例)
- [8. Service Mesh 模式](#8-service-mesh-模式)
  - [8.1 通讯治理](#81-通讯治理)
  - [8.2 典型案例](#82-典型案例)
- [9. Observability 模式](#9-observability-模式)
  - [9.1 统一监控](#91-统一监控)
  - [9.2 典型案例](#92-典型案例)
- [10. 组合模式的最佳实践](#10-组合模式的最佳实践)
  - [10.1 边界清晰](#101-边界清晰)
  - [10.2 契约优先](#102-契约优先)
  - [10.3 无缝替换](#103-无缝替换)
  - [10.4 监控/治理](#104-监控治理)
- [11. 组合模式的形式化](#11-组合模式的形式化)
  - [11.1 组合函数](#111-组合函数)
  - [11.2 范畴论视角](#112-范畴论视角)
...
- **相关文档**：
  ...
  - `architecture-view/08-composition-patterns/` - 组合模式详细文档
- **学术资源**：
