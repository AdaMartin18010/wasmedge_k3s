...
- [1. 概述](#1-概述)
- [2. 模式定义](#2-模式定义)
  - [2.1 Adapter 模式](#21-adapter-模式)
  - [2.2 Bridge 模式](#22-bridge-模式)
- [3. 典型应用场景](#3-典型应用场景)
  - [3.1 容器化迁移](#31-容器化迁移)
  - [3.2 协议转换](#32-协议转换)
  - [3.3 跨平台兼容](#33-跨平台兼容)
- [4. 形式化描述](#4-形式化描述)
  - [4.1 Adapter 形式化](#41-adapter-形式化)
  - [4.2 Bridge 形式化](#42-bridge-形式化)
  - [4.3 组合语义](#43-组合语义)
- [5. 架构案例](#5-架构案例)
  - [5.1 案例：传统 Web 应用容器化](#51-案例传统-web-应用容器化)
  - [5.2 案例：gRPC 到 REST 的协议转换](#52-案例grpc-到-rest-的协议转换)
  - [5.3 案例：跨架构容器运行](#53-案例跨架构容器运行)
- [6. 组合模式集成](#6-组合模式集成)
  - [6.1 与 Service Mesh 集成](#61-与-service-mesh-集成)
  - [6.2 与 OPA 集成](#62-与-opa-集成)
- [7. 2025 年 11 月最新趋势](#7-2025-年-11-月最新趋势)
  - [7.1 自动化迁移工具](#71-自动化迁移工具)
  - [7.2 跨平台运行时](#72-跨平台运行时)
  - [7.3 智能适配](#73-智能适配)
- [8. 最佳实践](#8-最佳实践)
  - [8.1 设计原则](#81-设计原则)
  - [8.2 实现建议](#82-实现建议)
