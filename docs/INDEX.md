...
- [28. 架构框架](TECHNICAL/08-architecture-analysis/architecture-framework/architecture-framework.md) -
  多维度架构体系与技术规范
- [全局视角文档](../view/global_perspective.md) ⭐⭐ - 全局视角：云原生技术栈的完整知识体系（全局思维导图、多维概念矩阵、范畴论理论模型全面梳理、15个代码示例+15个Kubernetes应用+45+个量化数据）（2025-11-15 新增）
...
7. [文档一致性检查清单](DOCUMENTATION-CONSISTENCY-CHECKLIST.md) ⭐ - 文档一致性
   检查清单（快速参考）
8. [REFERENCES.md](REFERENCES.md) - 参考资源
...
- **总文档数**：47 个核心文档（含可选文档和分析文档，新增 AI/ML 架构视角、边缘计算架构视角、核心概念词典、版本信息更新机制、性能测试指南、全局视角文档）
...
- ⭐ 新增版本信息更新机制（文档 39）
- ⭐ 新增性能测试指南（文档 40）
- ⭐ 新增全局视角文档（`view/global_perspective.md`）- 全局思维导图、多维概念矩阵、范畴论理论模型全面梳理、15个代码示例+15个Kubernetes应用+45+个量化数据
