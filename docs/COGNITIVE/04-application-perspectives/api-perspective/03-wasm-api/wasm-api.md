...
- [WASM 化 API 规范](#wasm-化-api-规范)
  ...
  - [3 WIT 组件模型](#3-wit-组件模型)
    ...
    - [3.3 WIT 版本化](#33-wit-版本化)
  - [4 WasmEdge API](#4-wasmedge-api)
    - [4.1 WasmEdge Runtime API](#41-wasmedge-runtime-api)
    - [4.2 WasmEdge 0.14 新特性（2024）](#42-wasmedge-014-新特性2024)
    - [4.3 WasmEdge Kubernetes 集成](#43-wasmedge-kubernetes-集成)
  - [5 wasmCloud Lattice API](#5-wasmcloud-lattice-api)
    - [5.1 Lattice 组件通信 API](#51-lattice-组件通信-api)
    - [5.2 Lattice 组件发现 API](#52-lattice-组件发现-api)
  - [6 WASM 组件组合 API](#6-wasm-组件组合-api)
    - [6.1 组件导入/导出 API](#61-组件导入导出-api)
    - [6.2 组件组合模式](#62-组件组合模式)
