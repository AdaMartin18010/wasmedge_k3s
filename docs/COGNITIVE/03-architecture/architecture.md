# 03. 架构与对象模型：控制闭环与数据结构

## 目录

- [目录](#目录)
- [03.1 文档定位](#031-文档定位)
- [03.2 架构层次对比](#032-架构层次对比)
  - [03.2.1 系统架构全景](#0321-系统架构全景)
  - [03.2.2 架构设计论证](#0322-架构设计论证)
- [03.3 Kubernetes 对象模型](#033-kubernetes-对象模型)
  - [03.3.1 GVR 模型](#0331-gvr-模型)
  - [03.3.2 对象结构](#0332-对象结构)
  - [03.3.3 对象关系模型](#0333-对象关系模型)
  - [03.3.4 标签与选择器](#0334-标签与选择器)
  - [03.3.5 对象模型论证](#0335-对象模型论证)
- [03.4 控制闭环机制](#034-控制闭环机制)
  - [03.4.1 Informer 工作流程](#0341-informer-工作流程)
  - [03.4.2 Controller 模式](#0342-controller-模式)
  - [03.4.3 控制循环时序图](#0343-控制循环时序图)
  - [03.4.4 控制闭环论证](#0344-控制闭环论证)
- [03.5 Docker 控制路径](#035-docker-控制路径)
  - [03.5.1 调用链路](#0351-调用链路)
  - [03.5.2 shim 的必要性](#0352-shim-的必要性)
  - [03.5.3 技术场景与决策](#0353-技术场景与决策)
- [03.6 Kubernetes 调度算法](#036-kubernetes-调度算法)
  - [03.6.1 调度流程](#0361-调度流程)
  - [03.6.2 调度策略](#0362-调度策略)
  - [03.6.3 调度场景与决策](#0363-调度场景与决策)
  - [03.6.4 执行流与调度视角](#0364-执行流与调度视角)
- [03.7 网络模型强制要求](#037-网络模型强制要求)
  - [03.7.1 Kubernetes 网络原则](#0371-kubernetes-网络原则)
  - [03.7.2 实现方式](#0372-实现方式)
  - [03.7.3 网络模型对比](#0373-网络模型对比)
  - [03.7.4 网络场景与决策](#0374-网络场景与决策)
- [03.8 存储抽象：CSI](#038-存储抽象csi)
  - [03.8.1 CSI 的必要性](#0381-csi-的必要性)
  - [03.8.2 存储模型](#0382-存储模型)
  - [03.8.3 存储场景与决策](#0383-存储场景与决策)
- [03.9 K3s 架构精简](#039-k3s-架构精简)
  - [03.9.1 裁剪清单](#0391-裁剪清单)
  - [03.9.2 单二进制打包策略](#0392-单二进制打包策略)
  - [03.9.3 高可用路径](#0393-高可用路径)
  - [03.9.4 边缘场景存储决策](#0394-边缘场景存储决策)
- [03.10 数据结构对比](#0310-数据结构对比)
  - [03.10.1 数据结构分析](#03101-数据结构分析)
- [03.11 性能考量](#0311-性能考量)
  - [03.11.1 事件吞吐](#03111-事件吞吐)
  - [03.11.2 K3s 性能论证](#03112-k3s-性能论证)
- [03.12 技术场景分析](#0312-技术场景分析)
  - [03.12.1 大规模集群场景](#03121-大规模集群场景)
  - [03.12.2 边缘场景](#03122-边缘场景)
  - [03.12.3 混合架构场景](#03123-混合架构场景)
- [03.13 决策依据与思路](#0313-决策依据与思路)
  - [03.13.1 架构选择决策树](#03131-架构选择决策树)
  - [03.13.2 存储选择决策树](#03132-存储选择决策树)
  - [03.13.3 网络选择决策树](#03133-网络选择决策树)
- [03.14 形式化总结](#0314-形式化总结)
  - [03.14.1 架构模型形式化](#03141-架构模型形式化)
  - [03.14.2 性能模型形式化](#03142-性能模型形式化)
  - [03.14.3 对象模型形式化](#03143-对象模型形式化)
- [03.15 参考](#0315-参考)
