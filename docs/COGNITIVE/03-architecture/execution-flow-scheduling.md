# 03.X 执行流与调度视角：虚拟化技术本质分析

## 目录

- [目录](#目录)
- [03.X.1 文档定位](#03x1-文档定位)
- [03.X.2 执行流视角总览](#03x2-执行流视角总览)
  - [03.X.2.1 思维导图全景](#03x21-思维导图全景)
  - [03.X.2.2 核心对比矩阵](#03x22-核心对比矩阵)
- [03.X.3 全虚拟化执行流](#03x3-全虚拟化执行流)
  - [03.X.3.1 触发机制](#03x31-触发机制)
  - [03.X.3.2 截获机制](#03x32-截获机制)
  - [03.X.3.3 调度实体](#03x33-调度实体)
  - [03.X.3.4 执行路径](#03x34-执行路径)
  - [03.X.3.5 性能开销分析](#03x35-性能开销分析)
- [03.X.4 半虚拟化执行流](#03x4-半虚拟化执行流)
  - [03.X.4.1 触发机制](#03x41-触发机制)
  - [03.X.4.2 截获机制](#03x42-截获机制)
  - [03.X.4.3 调度实体](#03x43-调度实体)
  - [03.X.4.4 执行路径](#03x44-执行路径)
  - [03.X.4.5 性能开销分析](#03x45-性能开销分析)
- [03.X.5 容器化执行流](#03x5-容器化执行流)
  - [03.X.5.1 触发机制](#03x51-触发机制)
  - [03.X.5.2 截获机制](#03x52-截获机制)
  - [03.X.5.3 调度实体](#03x53-调度实体)
  - [03.X.5.4 执行路径](#03x54-执行路径)
  - [03.X.5.5 性能开销分析](#03x55-性能开销分析)
- [03.X.6 沙盒化执行流](#03x6-沙盒化执行流)
  - [03.X.6.1 触发机制](#03x61-触发机制)
  - [03.X.6.2 截获机制](#03x62-截获机制)
  - [03.X.6.3 调度实体](#03x63-调度实体)
  - [03.X.6.4 执行路径](#03x64-执行路径)
  - [03.X.6.5 性能开销分析](#03x65-性能开销分析)
- [03.X.7 对比论证](#03x7-对比论证)
  - [03.X.7.1 执行路径对比](#03x71-执行路径对比)
  - [03.X.7.2 性能开销对比](#03x72-性能开销对比)
  - [03.X.7.3 技术选型决策](#03x73-技术选型决策)
  - [03.X.7.4 基于设备与内核特性的决策](#03x74-基于设备与内核特性的决策)
    - [03.X.7.4.1 设备访问需求分析](#03x741-设备访问需求分析)
    - [03.X.7.4.2 内核特性需求分析](#03x742-内核特性需求分析)
    - [03.X.7.4.3 资源访问需求分析](#03x743-资源访问需求分析)
    - [03.X.7.4.4 综合决策树](#03x744-综合决策树)
    - [03.X.7.4.5 决策案例分析](#03x745-决策案例分析)
- [03.X.8 形式化模型](#03x8-形式化模型)
  - [03.X.8.1 执行流模型](#03x81-执行流模型)
  - [03.X.8.2 调度开销模型](#03x82-调度开销模型)
- [03.X.9 参考](#03x9-参考)
  - [相关文档](#相关文档)
  - [外部参考](#外部参考)
