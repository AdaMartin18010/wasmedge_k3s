...
- [12.6.2 案例研究](#1262-案例研究)
  - [📑 目录](#-目录)
  - [12.6.2.1 案例分类](#12621-案例分类)
    - [案例类型](#案例类型)
  - [12.6.2.2 技术选型案例](#12622-技术选型案例)
    - [案例 1：银行核心系统隔离方案选型](#案例-1银行核心系统隔离方案选型)
    - [案例 2：CI/CD 流水线隔离方案选型](#案例-2cicd-流水线隔离方案选型)
    - [案例 3：PC 端安全软件插件系统选型](#案例-3pc-端安全软件插件系统选型)
    - [案例 4：边缘 K8s 集群选型](#案例-4边缘-k8s-集群选型)
    - [案例 5：单节点 WASM-P2P 应用选型](#案例-5单节点-wasm-p2p-应用选型)
  - [12.6.2.3 架构设计案例](#12623-架构设计案例)
    - [案例 1：微服务架构的结构设计](#案例-1微服务架构的结构设计)
    - [案例 2：函数式编程架构的结构设计](#案例-2函数式编程架构的结构设计)
  - [12.6.2.4 故障分析案例](#12624-故障分析案例)
    - [案例 1：Meltdown 漏洞的结构分析](#案例-1meltdown-漏洞的结构分析)
    - [案例 2：Docker rm -rf / 的结构分析](#案例-2docker-rm--rf--的结构分析)
    - [案例 3：Java STW 卡顿的结构分析](#案例-3java-stw-卡顿的结构分析)
...
- **[结构主义设计指南](01-design-guidelines.md)** - 如何运用结构主义思想进行系统
  设计
  - **内容**：设计原则（结构决定性质、结构平衡、结构复合）、设计流程（需求分析、
    结构选型、结构验证、结构优化）、结构选型矩阵、结构验证检查清单
  - **适用场景**：系统设计和架构设计
