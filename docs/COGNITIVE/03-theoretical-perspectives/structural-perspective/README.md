...
- [12. 结构视角：计算机科学的结构主义分析](#12-结构视角计算机科学的结构主义分析)
  ...
  - [7 认知增强：思维导图、知识矩阵与专家观点](#7-认知增强思维导图知识矩阵与专家观点)
    - [7.1 结构视角完整思维导图](#71-结构视角完整思维导图)
    - [7.2 知识多维关系矩阵](#72-知识多维关系矩阵)
      - [三大结构多维关系矩阵](#三大结构多维关系矩阵)
      - [虚拟化层次结构分析矩阵](#虚拟化层次结构分析矩阵)
    - [7.3 形象化解释论证](#73-形象化解释论证)
      - [结构视角的形象化类比](#结构视角的形象化类比)
        - [1. 计算结构 = 工厂生产线](#1-计算结构--工厂生产线)
        - [2. 控制结构 = 交通信号灯系统](#2-控制结构--交通信号灯系统)
        - [3. 信息结构 = 图书馆分类系统](#3-信息结构--图书馆分类系统)
        - [4. 三元结构 = 三原色系统](#4-三元结构--三原色系统)
    - [7.4 专家观点与论证](#74-专家观点与论证)
      - [计算信息软件科学家的观点](#计算信息软件科学家的观点)
        - [1. Nicolas Bourbaki（布尔巴基学派）](#1-nicolas-bourbaki布尔巴基学派)
        - [2. Jean Dieudonné（布尔巴基学派成员）](#2-jean-dieudonné布尔巴基学派成员)
      - [计算信息软件教育家的观点](#计算信息软件教育家的观点)
        - [1. Seymour Papert（建构主义教育家）](#1-seymour-papert建构主义教育家)
        - [2. Alan Kay（面向对象编程创始人）](#2-alan-kay面向对象编程创始人)
