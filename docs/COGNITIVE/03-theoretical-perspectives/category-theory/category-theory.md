...
- [范畴论视角：对象、态射与函子](#范畴论视角对象态射与函子)
  ...
  - [4 函子](#4-函子)
    - [4.1 镜像构建函子](#41-镜像构建函子)
    - [4.2 状态同步函子](#42-状态同步函子)
    - [4.3 调度函子](#43-调度函子)
    - [4.4 转换函子](#44-转换函子)
  - [5 自然变换](#5-自然变换)
    - [5.1 运行时转换](#51-运行时转换)
    - [5.2 API 版本转换](#52-api-版本转换)
    - [5.3 格式转换](#53-格式转换)
  - [6 单子](#6-单子)
    - [6.1 Option 单子](#61-option-单子)
    - [6.2 State 单子](#62-state-单子)
    - [6.3 Error 单子](#63-error-单子)
    - [6.4 Future 单子](#64-future-单子)
  - [7 极限与余极限](#7-极限与余极限)
    - [7.1 积与余积](#71-积与余积)
    - [7.2 等化子与余等化子](#72-等化子与余等化子)
    - [7.3 拉回与推出](#73-拉回与推出)
  - [8 范畴复合](#8-范畴复合)
    - [8.1 范畴的乘积](#81-范畴的乘积)
    ...
    - [8.3 函子范畴](#83-函子范畴)
  - [9 伴随函子](#9-伴随函子)
    - [9.1 伴随函子定义](#91-伴随函子定义)
    - [9.2 Yoneda 引理](#92-yoneda-引理)
  - [10 范畴等价](#10-范畴等价)
    - [10.1 范畴同构](#101-范畴同构)
    - [10.2 范畴等价](#102-范畴等价)
    - [10.3 范畴对偶](#103-范畴对偶)
  ...
  - [13 认知增强：思维导图、知识矩阵与专家观点](#13-认知增强思维导图知识矩阵与专家观点)
    ...
    - [13.4 专家观点与论证](#134-专家观点与论证)
      ...
      - [1. Benjamin Pierce（类型论专家）](#1-benjamin-pierce类型论专家)
      - [2. Robert Harper（编程语言理论专家）](#2-robert-harper编程语言理论专家)
