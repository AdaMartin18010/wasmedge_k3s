# 09.3 属性矩阵：概念属性在不同场景下的表现

## 目录

- [目录](#目录)
- [09.3.1 属性矩阵定义](#0931-属性矩阵定义)
- [09.3.2 成熟度属性矩阵](#0932-成熟度属性矩阵)
  - [成熟度属性分析](#成熟度属性分析)
- [09.3.3 性能属性矩阵](#0933-性能属性矩阵)
- [09.3.4 成本属性矩阵](#0934-成本属性矩阵)
- [09.3.5 兼容性属性矩阵](#0935-兼容性属性矩阵)
- [09.3.6 属性矩阵的综合评估](#0936-属性矩阵的综合评估)
...
- [属性矩阵 - 返回目录](../09-matrix-perspective/README.md)
