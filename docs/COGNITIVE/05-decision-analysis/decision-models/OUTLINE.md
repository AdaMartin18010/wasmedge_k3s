...
- [10. 技术决策模型与架构选择：虚拟化、容器化、沙盒化的技术架构模型选择](#10-技术决策模型与架构选择虚拟化容器化沙盒化的技术架构模型选择)
  - [📑 目录](#-目录)
  - [📋 文档提纲（草案）](#-文档提纲草案)
  - [1 文档定位](#1-文档定位)
  - [2 虚拟化、容器化、沙盒化的技术架构模型](#2-虚拟化容器化沙盒化的技术架构模型)
    ...
    - [10.2.6 分布式系统与集群模型（底层支撑模型）](#1026-分布式系统与集群模型底层支撑模型)
      - [10.2.6.1 分布式系统架构模型](#10261-分布式系统架构模型)
    ...
    - [10.3 物理资源层面的权衡模型](#103-物理资源层面的权衡模型)
      - [10.3.1 CPU 资源模型与权衡](#1031-cpu-资源模型与权衡)
