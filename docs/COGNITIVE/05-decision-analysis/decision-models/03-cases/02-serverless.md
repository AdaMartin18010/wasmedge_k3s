...
- [02. Serverless 函数服务案例](#02-serverless-函数服务案例)
  - [📑 目录](#-目录)
  - [1 案例背景](#1-案例背景)
  - [2 场景需求分析](#2-场景需求分析)
    - [2.1 业务需求](#21-业务需求)
  ...
  - [2025 年最新实践](#2025-年最新实践)
    - [Serverless 函数服务最佳实践（2025）](#serverless-函数服务最佳实践2025)
  - [实际应用案例](#实际应用案例)
    - [案例 1：高并发 Serverless 平台（2025）](#案例-1高并发-serverless-平台2025)
...
3. **GPU 设备**：部分 AI 函数可能需要 GPU 加速（可选）
   - **AI 推理函数**：如需 GPU 加速，通常使用 GPU 直通方式
   - **决策**：中等隔离 → 容器化（NVIDIA Container Toolkit，性能>98%，快速启动）
   - **注意**：Serverless 函数通常按需计费，GPU 资源可能按使用时长计费，成本较高
