...
- [网络概念与技术名词论证](#网络概念与技术名词论证)
  - [📑 目录](#-目录)
  - [1 文档定位](#1-文档定位)
  - [2 网络拓扑结构](#2-网络拓扑结构)
    - [2.1 物理拓扑结构](#21-物理拓扑结构)
      - [2.1.1 物理拓扑定义](#211-物理拓扑定义)
      - [2.1.2 物理拓扑在技术栈中的作用](#212-物理拓扑在技术栈中的作用)
    - [2.2 逻辑拓扑结构](#22-逻辑拓扑结构)
      - [2.2.1 逻辑拓扑定义](#221-逻辑拓扑定义)
      - [2.2.2 逻辑拓扑在技术栈中的作用](#222-逻辑拓扑在技术栈中的作用)
    - [2.3 拓扑结构映射](#23-拓扑结构映射)
      - [2.3.1 物理拓扑与逻辑拓扑映射](#231-物理拓扑与逻辑拓扑映射)
      - [2.3.2 各范式拓扑结构映射](#232-各范式拓扑结构映射)
  - [3 通讯链接模式](#3-通讯链接模式)
    - [3.1 单工通讯](#31-单工通讯)
      - [3.1.1 单工通讯定义](#311-单工通讯定义)
      - [3.1.2 单工通讯在各范式中的应用](#312-单工通讯在各范式中的应用)
    - [3.2 半双工通讯](#32-半双工通讯)
      - [3.2.1 半双工通讯定义](#321-半双工通讯定义)
      - [3.2.2 半双工通讯在各范式中的应用](#322-半双工通讯在各范式中的应用)
    - [3.3 全双工通讯](#33-全双工通讯)
      - [3.3.1 全双工通讯定义](#331-全双工通讯定义)
      - [3.3.2 全双工通讯在各范式中的应用](#332-全双工通讯在各范式中的应用)
    - [3.4 通讯链接模式映射](#34-通讯链接模式映射)
      - [3.4.1 通讯链接模式对比矩阵](#341-通讯链接模式对比矩阵)
      - [3.4.2 各范式通讯链接模式映射](#342-各范式通讯链接模式映射)
  - [4 信道模型](#4-信道模型)
    - [4.1 物理信道](#41-物理信道)
      - [4.1.1 物理信道定义](#411-物理信道定义)
      - [4.1.2 物理信道在技术栈中的作用](#412-物理信道在技术栈中的作用)
    - [4.2 逻辑信道](#42-逻辑信道)
      - [4.2.1 逻辑信道定义](#421-逻辑信道定义)
      - [4.2.2 逻辑信道在技术栈中的作用](#422-逻辑信道在技术栈中的作用)
    - [4.3 信道映射](#43-信道映射)
      - [4.3.1 物理信道与逻辑信道映射](#431-物理信道与逻辑信道映射)
      - [4.3.2 各范式信道模型映射](#432-各范式信道模型映射)
  - [5 网卡模型](#5-网卡模型)
    - [5.1 物理网卡](#51-物理网卡)
      - [5.1.1 物理网卡定义](#511-物理网卡定义)
      - [5.1.2 物理网卡在技术栈中的作用](#512-物理网卡在技术栈中的作用)
    - [5.2 虚拟网卡](#52-虚拟网卡)
      - [5.2.1 虚拟网卡定义](#521-虚拟网卡定义)
      - [5.2.2 虚拟网卡在技术栈中的作用](#522-虚拟网卡在技术栈中的作用)
    - [5.3 逻辑网卡](#53-逻辑网卡)
      - [5.3.1 逻辑网卡定义](#531-逻辑网卡定义)
      - [5.3.2 逻辑网卡在技术栈中的作用](#532-逻辑网卡在技术栈中的作用)
    - [5.4 网卡模型映射](#54-网卡模型映射)
      - [5.4.1 网卡模型对比矩阵](#541-网卡模型对比矩阵)
      - [5.4.2 各范式网卡模型映射](#542-各范式网卡模型映射)
  - [6 网络协议栈](#6-网络协议栈)
    - [6.1 OSI 七层模型](#61-osi-七层模型)
      - [6.1.1 OSI 模型定义](#611-osi-模型定义)
      - [6.1.2 OSI 模型在各范式中的映射](#612-osi-模型在各范式中的映射)
    - [6.2 TCP/IP 四层模型](#62-tcpip-四层模型)
      - [6.2.1 TCP/IP 模型定义](#621-tcpip-模型定义)
      - [6.2.2 TCP/IP 模型在各范式中的映射](#622-tcpip-模型在各范式中的映射)
    - [6.3 各范式网络栈对比](#63-各范式网络栈对比)
      - [6.3.1 网络栈对比矩阵](#631-网络栈对比矩阵)
  - [7 虚拟化网络架构](#7-虚拟化网络架构)
    - [7.1 虚拟化网络拓扑](#71-虚拟化网络拓扑)
      - [7.1.1 虚拟化网络拓扑结构](#711-虚拟化网络拓扑结构)
    - [7.2 虚拟化网卡模型](#72-虚拟化网卡模型)
      - [7.2.1 虚拟化网卡架构](#721-虚拟化网卡架构)
    - [7.3 虚拟化网络隔离](#73-虚拟化网络隔离)
      - [7.3.1 虚拟化网络隔离机制](#731-虚拟化网络隔离机制)
  - [8 容器化网络架构](#8-容器化网络架构)
    - [8.1 容器化网络拓扑](#81-容器化网络拓扑)
      - [8.1.1 容器化网络拓扑结构](#811-容器化网络拓扑结构)
    - [8.2 容器化网卡模型](#82-容器化网卡模型)
      - [8.2.1 容器化网卡架构](#821-容器化网卡架构)
    - [8.3 容器化网络隔离](#83-容器化网络隔离)
      - [8.3.1 容器化网络隔离机制](#831-容器化网络隔离机制)
  - [9 沙盒化网络架构](#9-沙盒化网络架构)
    - [9.1 沙盒化网络拓扑](#91-沙盒化网络拓扑)
      - [9.1.1 沙盒化网络拓扑结构](#911-沙盒化网络拓扑结构)
    - [9.2 沙盒化网卡模型](#92-沙盒化网卡模型)
      - [9.2.1 沙盒化网卡架构](#921-沙盒化网卡架构)
    - [9.3 沙盒化网络隔离](#93-沙盒化网络隔离)
      - [9.3.1 沙盒化网络隔离机制](#931-沙盒化网络隔离机制)
