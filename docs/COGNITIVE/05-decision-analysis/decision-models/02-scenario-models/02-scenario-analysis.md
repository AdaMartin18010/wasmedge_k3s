...
- [02. 技术场景分析论证模型](#02-技术场景分析论证模型)
  - [📑 目录](#-目录)
  - [1 概述](#1-概述)
  - [2 场景分析框架](#2-场景分析框架)
    - [2.1 业务需求分析](#21-业务需求分析)
    - [2.2 技术约束分析](#22-技术约束分析)
    - [2.3 运营要求分析](#23-运营要求分析)
  - [3 论证模型](#3-论证模型)
    - [3.1 论证逻辑链条](#31-论证逻辑链条)
    - [3.2 论证模型示例](#32-论证模型示例)
      - [论证模型示例 1：Serverless 场景技术选型](#论证模型示例-1serverless-场景技术选型)
        - [示例 1：问题识别](#示例-1问题识别)
        - [示例 1：需求分析](#示例-1需求分析)
        - [示例 1：技术选项枚举](#示例-1技术选项枚举)
        - [示例 1：权衡评估](#示例-1权衡评估)
        - [示例 1：决策选择](#示例-1决策选择)
      - [论证模型示例 2：高并发网络 I/O 场景技术选型](#论证模型示例-2高并发网络-io-场景技术选型)
        - [示例 2：问题识别](#示例-2问题识别)
        - [示例 2：需求分析](#示例-2需求分析)
        - [示例 2：技术选项枚举](#示例-2技术选项枚举)
        - [示例 2：权衡评估](#示例-2权衡评估)
        - [示例 2：决策选择](#示例-2决策选择)
      - [论证模型示例 3：USB 设备访问场景技术选型](#论证模型示例-3usb-设备访问场景技术选型)
        - [示例 3：问题识别](#示例-3问题识别)
        - [示例 3：需求分析](#示例-3需求分析)
        - [示例 3：技术选项枚举](#示例-3技术选项枚举)
        - [示例 3：权衡评估](#示例-3权衡评估)
        - [示例 3：决策选择](#示例-3决策选择)
      - [论证模型示例 4：GPU 加速应用（AI 推理）场景技术选型](#论证模型示例-4gpu-加速应用ai-推理场景技术选型)
        - [示例 4：问题识别](#示例-4问题识别)
        - [示例 4：需求分析](#示例-4需求分析)
        - [示例 4：技术选项枚举](#示例-4技术选项枚举)
        - [示例 4：权衡评估](#示例-4权衡评估)
        - [示例 4：决策选择](#示例-4决策选择)
    - [3.3 论证验证方法](#33-论证验证方法)
  - [4 场景-技术映射关系](#4-场景-技术映射关系)
    - [4.1 场景分类](#41-场景分类)
    - [4.2 技术选择映射](#42-技术选择映射)
    - [4.3 映射决策规则](#43-映射决策规则)
  - [5 参考](#5-参考)
  - [2025 年最新实践](#2025-年最新实践)
    - [技术场景分析应用最佳实践（2025）](#技术场景分析应用最佳实践2025)
  - [实际应用案例](#实际应用案例)
    - [案例 1：Serverless 场景技术选型（2025）](#案例-1serverless-场景技术选型2025)
...
| **微服务架构**   | 快速迭代、服务治理   | 资源中等、容器友好   | 无需求   | epoll/io_uring   | DevOps、CI/CD      | Container + K8s + Service Mesh | 标准化、服务间通信治理、零信任安全 |
