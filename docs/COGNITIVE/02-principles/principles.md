...
- [目录](#目录)
- [02.1 文档定位](#021-文档定位)
- [02.2 三大核心理念](#022-三大核心理念)
  - [02.2.1 集装箱化（Containerization）](#0221-集装箱化containerization)
    - [02.2.1.1 问题域与核心思想](#02211-问题域与核心思想)
    - [02.2.1.2 技术实现路径](#02212-技术实现路径)
    - [02.2.1.3 演进路径分析](#02213-演进路径分析)
    - [02.2.1.4 技术场景与决策](#02214-技术场景与决策)
  - [02.2.2 声明式（Declarative）](#0222-声明式declarative)
    - [02.2.2.1 问题域与核心思想](#02221-问题域与核心思想)
    - [02.2.2.2 控制循环原理](#02222-控制循环原理)
    - [02.2.2.3 声明式 vs 命令式](#02223-声明式-vs-命令式)
    - [02.2.2.4 技术场景与决策](#02224-技术场景与决策)
  - [02.2.3 弹性（Resilience）](#0223-弹性resilience)
    - [02.2.3.1 问题域与核心思想](#02231-问题域与核心思想)
    - [02.2.3.2 弹性机制](#02232-弹性机制)
    - [02.2.3.3 弹性策略矩阵](#02233-弹性策略矩阵)
    - [02.2.3.4 技术场景与决策](#02234-技术场景与决策)
- [02.3 理念关联图](#023-理念关联图)
- [02.4 技术决策参考](#024-技术决策参考)
  - [02.4.1 何时选择声明式？](#0241-何时选择声明式)
  - [02.4.2 何时需要弹性设计？](#0242-何时需要弹性设计)
- [02.5 形式化总结](#025-形式化总结)
  - [02.5.1 理念关系式](#0251-理念关系式)
  - [02.5.2 控制循环收敛定理](#0252-控制循环收敛定理)
  - [02.5.3 弹性决策模型](#0253-弹性决策模型)
- [02.6 参考](#026-参考)
