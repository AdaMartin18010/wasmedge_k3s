...
- [目录](#目录)
- [11.8.1 案例概述](#1181-案例概述)
- [11.8.2 案例 1：I∘C∘S∘M（标准微服务）](#1182-案例-1icsm标准微服务)
- [11.8.3 案例 2：V∘S∘C∘M（强隔离微服务）](#1183-案例-2vscm强隔离微服务)
- [11.8.4 案例 3：I∘C∘S∘W（边缘计算）](#1184-案例-3icsw边缘计算)
- [11.8.5 案例 4：I∘C∘S∘Am（轻量级微服务）](#1185-案例-4icsam轻量级微服务)
- [11.8.6 案例 5：V∘C∘S∘M（混合架构）](#1186-案例-5vcsm混合架构)
- [11.8.7 案例对比矩阵](#1187-案例对比矩阵)
- [11.8.8 参考](#1188-参考)
