...
- [11.1.1 算子概述](#1111-算子概述)
- [11.1.2 20 个一元算子详解](#1112-20-个一元算子详解)
  - [11.1.2.1 虚拟化算子（V）](#11121-虚拟化算子v)
  - [11.1.2.2 镜像打包算子（I）](#11122-镜像打包算子i)
  - [11.1.2.3 容器化算子（C）](#11123-容器化算子c)
  - [11.1.2.4 沙盒化算子（S）](#11124-沙盒化算子s)
  - [11.1.2.5 服务网格算子（M）](#11125-服务网格算子m)
  - [11.1.2.6 其他算子](#11126-其他算子)
...
- [11.1.3 算子三元组解构](#1113-算子三元组解构)
- [11.1.4 算子映射关系](#1114-算子映射关系)
- [11.1.5 参考](#1115-参考)
...
- **[算子定义](../../11-algebraic-structure/01-operator-definition.md)** - 20 个
  一元算子详解
- **[代数结构](../../11-algebraic-structure/02-algebraic-structure.md)** - 代数
  结构 Σ = ⟨Ω, ℱ, 𝒫, ℒ⟩
- **[公理体系](../../11-algebraic-structure/03-axioms.md)** - 公理 A1-A7
- **[复合运算表](../../11-algebraic-structure/04-composition-table.md)** - 20×20
  运算表
