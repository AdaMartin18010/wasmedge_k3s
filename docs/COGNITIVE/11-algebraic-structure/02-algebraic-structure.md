...
- [目录](#目录)
- [11.2.1 代数结构概述](#1121-代数结构概述)
- [11.2.2 对象集合 Ω](#1122-对象集合-ω)
  - [硬件/固件层](#硬件固件层)
